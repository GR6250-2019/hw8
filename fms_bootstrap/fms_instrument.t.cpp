...
//implement test for instrument_fra
template<class U, class C>
...
//implement test for instrument_swap
template<class U, class C, class T>
int test_instrument_swap()
{
	interest_rate_swap<U, C> swap(1, 1, 1);
...
int test_instrument_swap_int_int = test_instrument_swap<int, int, int>();
