...
// Testing forward rate agreement
/*
template<class U, class C>
int test_instrument_fra()
{
	forward_rate_agreement<U, C> fra(2, 3);
...
// Testing Interest rate swap

template<class U, class C>
int test_instrument_swap()
{
	interest_rate_swap<U, U, C> swap(2, 2, 3);
