...
namespace fms::instrument {
	...
	struct forward_rate_agreements : public sequence<fms::sequence::list<U>, fms::sequence::list<C>> {
		forward_rate_agreements(U effective, U tenor, C forward)
			: sequence< fms::sequence::list<U>, fms::sequence::list<C>>(fms::sequence::list<U>({ 0, effective, effective + tenor }), fms::sequence::list<C>({ 0, -1, 1 + forward * tenor }))
		{ }
	};
}
