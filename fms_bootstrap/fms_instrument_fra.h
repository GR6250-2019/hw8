...
namespace fms::instrument {
	...
	struct forward_rate_agreement : public sequence<fms::sequence::list<U>, fms::sequence::list<U>, fms::sequence::list<C>> {
	forward_rate_agreement(U effective, U tenor, C forward)
			: sequence<fms::sequence::list<U>, sequence<fms::sequence::list<U>, fms::sequence::list<C>>(
