...
#pragma once//!!! Implement the class forward_rate_agreement in namespace fms::instrument.
#include "fms_instrument_sequence.h"namespace fms::instrument { template<class U = double, class C = double>
