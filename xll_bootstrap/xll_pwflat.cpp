...
AddIn xai_pwflat_forward_spot(
	...
	.Arg(XLL_FP, L"times", L"is an array of times at which to find the forward value. ")
	.Category(CATEGORY)
	.FunctionHelp(L"Return spot rate corresponding to times. ")
	.Documentation(
		L"Return spot rate corresponding to times. "
	)
);
...
AddIn xai_pwflat_forward_discount(
	...
	.Arg(XLL_FP, L"times", L"is an array of times at which to find the forward value. ")
	.Category(CATEGORY)
	.FunctionHelp(L"Return discount rate corresponding to times. ")
	.Documentation(
		L"Return discount rate corresponding to times. "
	)
);
