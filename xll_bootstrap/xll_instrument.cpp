...
AddIn xai_instrument_far(
	...
	.Arg(XLL_DOUBLE, L"effective", L"is the time in years at which the forward rate begins.")
...
AddIn xai_instrument_swap(
	...
	.Arg(XLL_DOUBLE, L"maturity", L"is the time in years at which the forward rate begins.")
