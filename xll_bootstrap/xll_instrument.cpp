...
AddIn xai_instrument_fra(
	...
	.Arg(XLL_DOUBLE, L"effective", L"is the time in years until the effective date.")
	.Arg(XLL_DOUBLE, L"tenor", L"is the time in years past the effective date at which the forward rate agreement matures.")
...
AddIn xai_instrument_swap(
	...
	.Arg(XLL_DOUBLE, L"coupon", L"is the cash flow that is paid out periodically.")
	.Uncalced()
	.Category(CATEGORY)
